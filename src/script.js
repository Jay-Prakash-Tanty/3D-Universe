...
// const geeometry = new THREE.SphereGeometry( 0.1, 32, 16 ); 
// const maaterial = new THREE.MeshBasicMaterial( { color: "#000000" } ); 
// const sphere = new THREE.Mesh( geeometry, maaterial ); scene.add( sphere );
